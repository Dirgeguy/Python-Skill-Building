...
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        # Next, we create the board w/ helper function
    ...
    def dig(self, row, col):
        ...
        # return True if successful, False if bombed
...
def play(dim_size=10, num_bombs=10):
    ...
    while len(board.dug) < board.dim_size ** 2 - num_bombs:
        ...
        if row < 0 or row >= board.dim_size or col < 0 or col >= board.dim_size:
            print("Invalid location selected. Try a different coordinate.")
            continue
        ...
        if not safe:
            # dug a bomb, yikes.
            break # (game over rip in peace)
    if safe:
        print("Congrats! You have uncovered the bombs!")
    else:
        print("Sorry, you dead.")
        # let's reveal the entire board.
