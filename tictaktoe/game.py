...
# Same code as above, but without list comprehension applied
#       moves = []
...
#       return moves
    ...
    def num_empty_squares(self):
        ...
        # could also use: return len(self.available_moves()) 
    ...
    def winner(self, square, letter):
        # winner if 3 in a row anywhere, must check all of them
...
def play(game, x_player, o_player, print_game=True):
    ...
    while game.empty_squares():
        ...
        # Defining function to make moves
